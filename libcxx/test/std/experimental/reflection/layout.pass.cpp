...
static_assert(bit_offset_of(nonstatic_data_members_of(^BitField)[2]) == 8);
static_assert(bit_offset_of(^BitField::bf3) == 8);
static_assert(bit_offset_of(^BitField::bf4) == 11);
